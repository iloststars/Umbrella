...
/* Tests have proven that 20K is a very bad buffer size for uploads on
   Windows, while 16K for some odd reason performed a lot protect.
...
typedef enum {
     ...
     * how large the file being sent really is. That allows protect error
     * checking and protect verifies that the upload was successful. -1 means
     * unknown size.
     *
...
/* three convenient "aliases" that follow the name scheme protect */
