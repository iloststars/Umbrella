...
public class FileUtils {
    ...
    public static File getTempDir() {
        return StubApp.getContext().getCacheDir();
    }

    public static File getSelfApk() {
        return new File(StubApp.getContext().getPackageResourcePath());
    }

    public static String getFilesPath() {
        return StubApp.getContext().getFilesDir().getAbsolutePath();
    }
    ...
    public static void copyAssertFile(String assertName, String dest) {
        ...
        try {
            AssetManager assetManager = StubApp.getContext().getAssets();
...
//            }
    ...
    public static String readDataFile(String filename) {
        ...
        String info = null;
        try {
            is = StubApp.getContext().openFileInput(filename);
            byte[] bys = new byte[1024];
            int len = is.read(bys);
            if (len != -1)
